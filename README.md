...
```
cd existing_repo
git remote add origin http://git.biometriq.pl/mszulierz/asr-whisper.git
git branch -M main
...
- [ ] [Set up project integrations](http://git.biometriq.pl/mszulierz/asr-whisper/-/settings/integrations)
...
>>>>>>> 3056730d6eeaecdb18373adc15c1c883d678fd4f
